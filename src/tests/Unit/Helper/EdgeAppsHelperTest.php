...
class EdgeAppsHelperTest extends TestCase
{
    public function testGetEdgeAppsListNoOption(): void
    {
        ...
        $edgeAppsHelper = new EdgeAppsHelper($mockOptionRepository, $this->getMockBuilder(TaskRepository::class)->disableOriginalConstructor()->getMock());
    ...
    public function testGetEdgeAppsListOption(): void
    {
        ...
        $edgeAppsHelper = new EdgeAppsHelper($mockOptionRepository, $this->getMockBuilder(SystemHelper::class)->disableOriginalConstructor()->getMock());
